...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  PopScope _buildBody(double width, double height, Set<VideoModel> savedVideos) {
    return PopScope(
      canPop: false,
      onPopInvokedWithResult: (didPop, result) => BottomNavBarCubit.get(context).updateIndex(0),
      child: Scaffold(
